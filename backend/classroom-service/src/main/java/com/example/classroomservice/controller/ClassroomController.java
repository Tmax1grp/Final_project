...
public class ClassroomController {
    ...
    @GetMapping("/lectures/test")
//    @ResponseBody
    public Map<String, Object> allSearchClassRoomTest(@RequestParam("userId")Long userId){
//        final List<ClassRoomEntity> classList = classRoomRepository.findAll();
//        return classroomRepository.findAll();
        Map<String, Object> map = new ConcurrentHashMap<>();
        List<LectureEntity> lecture = lectureRepository.findClassroomEntityByUserId(userId);
        map.put("lecture", lecture);
        map.put("classroom", classroomRepository.findClassroomEntityByClassId(lecture.get(0).getClassroomId()));
